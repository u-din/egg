...
set zncprefix "*"
set znchost "znc.chating.id"
set zncNonSSLPort "2024"
set zncSSLPort ""
set zncWebNonSSLPort "2024"
set zncWebSSLPort ""
set zncAdminName "znc"
set zncAdminMail "isfan.dodent@gmail.com"
set zncRequestMail "isfan.dodent@gmail.com"
...
#               mail:simply:sendUserRequest3 $username $password
				...
				puthelp "PRIVMSG $requester :Server = znc.chating.id"
				puthelp "PRIVMSG $requester :Port = 2024"
				puthelp "PRIVMSG $requester :Ident = $username"
				puthelp "PRIVMSG $requester :ZNC webpanel : http://znc.chating.id:2024 login \00304$username\003 password \00304$password\003"
				#puthelp "PRIVMSG $requester :Cara pakai ZNC : Ganti IDENT dengan \00304$username\003 lalu konek ke ZNC dengan perintah /server znc.chating.id 2022 $username:$password"
				#puthelp "PRIVMSG $requester :\00304DILARANG\003 Jumpserver dari chatinh Network dan Jika ingin Menambah Network silahkan hubungi Admin yg aktive di #ZNC"
